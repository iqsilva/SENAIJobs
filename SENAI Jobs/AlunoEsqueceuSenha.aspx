<%@ Page Title="" Language="C#" MasterPageFile="~/SENAIJobs.Master" AutoEventWireup="true" CodeBehind="AlunoEsqueceuSenha.aspx.cs" Inherits="SENAI_Jobs.AlunoEsqueceuSenha" %>
...
<h1>Redefinição de Senha</h1>
        ...
        <asp:TextBox ID="TextBoxLogin" runat="server" ></asp:TextBox>
            ...
            <p>
            <asp:Label ID="LabelCPF" Text="CPF"  AssociatedControlID="TextBoxCPF" runat="server"></asp:Label>
            <asp:TextBox ID="TextBoxCPF" MaxLength="14" runat="server" ></asp:TextBox>
            </p>
            <p>
